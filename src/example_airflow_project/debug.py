...
def get_version(dist: str = "example-airflow-project") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["example-airflow-project"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("EXAMPLE_AIRFLOW_PROJECT")]]
    return Environment(
